...
parser.add_argument('--model_dir', type=str, default="/cos_person/training_output/model_fm_")
parser.add_argument('--save_dir', type=str, default="/cos_person/training_output/save_fm_")
...
def main(argv):
    ...
    def model_fn(features, labels, mode, params):
        ...
        fm_optimizer = tf.train.FtrlOptimizer(learning_rate=lr_map[args.model_name])
